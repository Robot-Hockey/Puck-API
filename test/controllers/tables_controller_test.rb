...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { description: @table.description, name: @table.name } }, as: :json
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { description: @table.description, name: @table.name } }, as: :json
    assert_response 200
  end
